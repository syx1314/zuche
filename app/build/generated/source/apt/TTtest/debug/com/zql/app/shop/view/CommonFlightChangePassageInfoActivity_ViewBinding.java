...
public class CommonFlightChangePassageInfoActivity_ViewBinding implements Unbinder {
  private CommonFlightChangePassageInfoActivity target;
  ...
  @UiThread
  public CommonFlightChangePassageInfoActivity_ViewBinding(CommonFlightChangePassageInfoActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CommonFlightChangePassageInfoActivity_ViewBinding(final CommonFlightChangePassageInfoActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CommonFlightChangePassageInfoActivity target = this.target;
