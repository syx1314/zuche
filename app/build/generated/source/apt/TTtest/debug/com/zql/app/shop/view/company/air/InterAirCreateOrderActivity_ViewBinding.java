...
import com.zql.app.shop.util.view.BTravelInfo;
...
public class InterAirCreateOrderActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public InterAirCreateOrderActivity_ViewBinding(InterAirCreateOrderActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public InterAirCreateOrderActivity_ViewBinding(final InterAirCreateOrderActivity target,
      View source) {
    this.target = target;
    ...
    target.linPolicy = Utils.findRequiredViewAsType(source, R.id.lin_policy, "field 'linPolicy'", LinearLayout.class);
    target.bTravelInfo = Utils.findRequiredViewAsType(source, R.id.view_travel_info, "field 'bTravelInfo'", BTravelInfo.class);
    ...
    target.btnPay = Utils.castView(view, R.id.p_flight_reserve_to_pay, "field 'btnPay'", Button.class);
    view2131298319 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
  ...
  @CallSuper
  public void unbind() {
    InterAirCreateOrderActivity target = this.target;
