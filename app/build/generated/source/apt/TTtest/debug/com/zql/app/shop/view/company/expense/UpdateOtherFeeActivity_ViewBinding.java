...
public class UpdateOtherFeeActivity_ViewBinding implements Unbinder {
  private UpdateOtherFeeActivity target;

  private View view2131299288;

  @UiThread
  public UpdateOtherFeeActivity_ViewBinding(UpdateOtherFeeActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UpdateOtherFeeActivity_ViewBinding(final UpdateOtherFeeActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UpdateOtherFeeActivity target = this.target;
