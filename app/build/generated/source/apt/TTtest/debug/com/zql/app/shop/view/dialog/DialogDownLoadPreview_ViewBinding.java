...
public class DialogDownLoadPreview_ViewBinding implements Unbinder {
  ...
  @UiThread
  public DialogDownLoadPreview_ViewBinding(DialogDownLoadPreview target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public DialogDownLoadPreview_ViewBinding(final DialogDownLoadPreview target, View source) {
    this.target = target;

    View view;
    target.floatSv = Utils.findRequiredViewAsType(source, R.id.floatSv, "field 'floatSv'", FloatScrollView.class);
    target.lin_float_title = Utils.findRequiredViewAsType(source, R.id.lin_float_title, "field 'lin_float_title'", LinearLayout.class);
    target.tvFloatTitle = Utils.findRequiredViewAsType(source, R.id.tv_float_title, "field 'tvFloatTitle'", TextView.class);
    target.tvFloatTime = Utils.findRequiredViewAsType(source, R.id.tv_float_time, "field 'tvFloatTime'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    DialogDownLoadPreview target = this.target;
    if (target == null) throw new IllegalStateException("Bindings already cleared.");
    this.target = null;

    target.floatSv = null;
    target.lin_float_title = null;
    target.tvFloatTitle = null;
    target.tvFloatTime = null;
