...
/**
 * 公用页面的基类
 * Created by huangzhe on 2017/4/26.
 */

public abstract class BaseCommonActivity<S extends ExtandsBaseService> extends TbiAppActivity<S> {
                ...
                for (int i = 0; i < grantResults.length; ++i) {
                    if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                        ...
                        if (!ActivityCompat.shouldShowRequestPermissionRationale(this, permissions[i])) {
                            new AlertDialog.Builder(ctx).setTitle("PermissionTest")//设置对话框标题
