...
public class LogMe {
	public static void d(Object msg) {
        if(msg==null){
        	if (IBaseConst.SYS.isTestMode) {
        	Log.d(IBaseConst.SYS.LOG_TAG, " >>>> msg is null !!!");
        	}
        	return ;
        }
		if (IBaseConst.SYS.isTestMode) {
			Log.d(IBaseConst.SYS.LOG_TAG, DateUtil.date2Str(new Date())+" "+msg.toString());
		}

		if(IBaseConst.SYS.isWrittenToSD){
			writeFileToSD("--------》"+msg.toString());
		}
	}

	public static void e(Object msg) {
		Log.e(IBaseConst.SYS.LOG_TAG, DateUtil.date2Str(new Date())+" "+msg+"");
		if(IBaseConst.SYS.isWrittenToSD){
			writeFileToSD("--------》"+msg.toString());
		}
	}
	...
	public static void e(String tag, Object msg) {
		Log.e(IBaseConst.SYS.LOG_TAG+tag, DateUtil.date2Str(new Date())+" "+msg+"");
		if(IBaseConst.SYS.isWrittenToSD){
			writeFileToSD("--------》"+msg.toString());
		}
	}
	...
	public static void d(String tag, Object msg) {
		...
		if (IBaseConst.SYS.isTestMode) {
			Log.d(IBaseConst.SYS.LOG_TAG + tag, DateUtil.date2Str(new Date())+" "+msg);
		}
		if(IBaseConst.SYS.isWrittenToSD){
