...
package com.zql.app.lib.view.component.wheel;
...
import com.zql.app.lib.view.component.wheel.adapters.WheelViewAdapter;
	...
	public void setCurrentItem(int index, boolean animated) {
		...
		if (index != currentItem) {
			if (animated) {
				...
				viewAdapter.setCurItem(currentItem);
...
//		centerDrawable.draw(canvas);
		...
		paint.setColor(getResources().getColor(R.color.seg_line));
		// 设置线宽
