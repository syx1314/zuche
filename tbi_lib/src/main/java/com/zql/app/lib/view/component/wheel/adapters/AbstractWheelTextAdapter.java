...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    /** Default text color */
    public static final int DEFAULT_TEXT_COLOR = 0xFF353535;
    ...
    protected static int maxsize = 16;
    protected static int minsize = 13;
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource,int currentIndex) {
        this(context, itemResource, NO_RESOURCE, currentIndex, maxsize, minsize);
    }
    ...
    public View getItem(int index, View convertView, ViewGroup parent) {
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {//把当前选中的item字体改大，其余变小
...
//                    textView.setTextColor(DEFAULT_VAL_TEXT_COLOR);
//                }
            }
            return convertView;
        }
...
//        view.setTextSize(textSize);
        view.setHeight(DisplayUtil.dipToPx(context,31f));
//        view.setLines(1);
